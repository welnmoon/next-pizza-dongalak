    ...
    <table className="w-full text-left border border-gray-200 rounded-md overflow-hidden">
      <tbody>
        <tr className="border-b">
          <th className="bg-gray-100 p-2 font-medium w-1/4">Имя</th>
          <td className="p-2">{selectedOrder?.fullName}</td>
        </tr>
        <tr className="border-b">
          <th className="bg-gray-100 p-2 font-medium">Email</th>
          <td className="p-2">{selectedOrder?.email}</td>
        </tr>
        <tr className="border-b">
          <th className="bg-gray-100 p-2 font-medium">Телефон</th>
          <td className="p-2">{selectedOrder?.phone}</td>
        </tr>
        <tr className="border-b">
          <th className="bg-gray-100 p-2 font-medium">Адрес</th>
          <td className="p-2">{selectedOrder?.address}</td>
        </tr>
        <tr className="border-b">
          <th className="bg-gray-100 p-2 font-medium">Статус</th>
          <td className="p-2">{selectedOrder?.status}</td>
        </tr>
        <tr>
          <th className="bg-gray-100 p-2 font-medium">Комментарий</th>
